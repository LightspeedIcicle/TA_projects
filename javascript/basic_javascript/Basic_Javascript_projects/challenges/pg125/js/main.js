...
function Houses() {
    document.getElementById("type_home").innerHTML = "John has a " + John.House_Style + " house made of " + John.House_Material + "." +
        " Its painted " + John.House_Color + " and has " + John.House_Number_of_rooms + " bedrooms.";
}